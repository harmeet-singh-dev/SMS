                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                <li class="nav-item">
                                    <a href="sub-admin" class="nav-link"><i class="fas fa-angle-right"></i>Sub Admin</a>
                                </li>
                                <li class="nav-item">
                      ...
                      <!--span v-if="success" :class="text-success">Record submitted successfully!</!--span-->      
                       ...
                       <form @submit.prevent="submit">
                            <div class="row">
                                   ...
                                   <input type="text" placeholder=""  v-model="form.first_name" class="form-control">
                                     <!--input type="text" placeholder="" v-model="form.place"  class="form-control"-->
                                    <div v-if="errors && errors.first_name" class="font-medium text-red-600">{{ errors.first_name[0] }}</div>

                                     <label>Last Name *</label>
                                   <input type="text" placeholder=""  v-model="form.last_name" class="form-control">
                                     <!--input type="text" placeholder="" v-model="form.place"  class="form-control"-->
                                    <div v-if="errors && errors.last_name" class="font-medium text-red-600">{{ errors.last_name[0] }}</div>
                                    
                                     <label>Email *</label>
                                   <input type="email" placeholder=""  v-model="form.email" class="form-control">
                                     <!--input type="text" placeholder="" v-model="form.place"  class="form-control"-->
