                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label for="first_name">Notice for teacher</label>
                                    <input type="checkbox" name="teacher" :checked="updateData.teacher">
                                </div>
                                <div class="form-group">
                                    <label for="first_name">Notice for student</label>
                                    <input type="checkbox" name="student" :checked="updateData.student">
                                </div>
...
export default {
    ...
    components: {
     ...
     methods: {
             ...
             update() {
            //show update popup
            this.$inertia.post(`/notice-update/update/${this.updateData.id}`, {
