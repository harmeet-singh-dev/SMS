                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="text-right">
                                <a href="/section" class="btn btn-primary"><i
                                    class="fas fa-plus"></i> Add Section</a>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table display data-table text-nowrap">
                            ...
                            <tbody>
                                <tr v-for="(user,index) in section.data" :key="index">
                         ...
                         <pagination class="mt-6" :links="section.links" />
                    </div>
                </div>
            </div>
        </div>
    ...
    methods: {
        ...
        destroy(id){
            if (confirm('Are you sure you want to delete this?')) {
                this.$inertia.post('all-section-destroy/destroy/' + id)
            }
        },

        update() {
            //show update popup
            this.$inertia.post(`/section-update/update/${this.updateData.id}`, {
    ...
    watch: {
        'indexForm.search': {
            handler: throttle(function () {
                this.$inertia.get('/all-section', pickBy(this.indexForm), {preserveState: true})
            }, 150),
        },
    },
