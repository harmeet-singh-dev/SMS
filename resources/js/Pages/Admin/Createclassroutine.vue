...
<!-- Page Area Start Here -->
 ...
 <option v-for='(sectiondata,index) in section' :key="index" :value='sectiondata.id'>{{ sectiondata.section_name }} </option>
                                    </select>
                                         </div>
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            <label>Subject </label>
                                           <select class="select2" v-model="form.subject_name">
                                        <option value="">Please Select Subject *</option>
 <option v-for='(subjectdata,index) in subject' :key="index" :value='subjectdata.id'>{{ subjectdata.subject_name }} </option>
                                    </select>
                                        </div>
 ...
 <option v-for='(teacherdata,index) in teacher' :key="index" :value='teacherdata.id'>{{ teacherdata.first_name }} {{ teacherdata.last_name }}</option>
                                    </select>
                                    </div>

                                       <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            <label>Select Time *</label>
                                           <input class="select2" type="time" v-model="form.start_time">
                                           <input class="select2" type="time" v-model="form.end_time">
                                    </div>

                                      <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            <label>Select Date</label>
                                           <input class="select2" type="date" v-model="form.date">
                                    ...
                                    <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                      ...
                                      <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                           ...
                                           <input class="select2" type="time" v-model="form.start_break">
                                           <input class="select2" type="time" v-model="form.end_break">
                                    </div>
