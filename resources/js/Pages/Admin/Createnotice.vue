                                    ...
                                    <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                        ...
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            ...
                                            <i class="fas fa-user"></i>
                                             <div v-if="errors && errors.posted_by" class="font-medium text-red-600">{{ errors.posted_by[0] }}</div>
                                        </div>
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            <label>Date </label>
                                        ...
                                        <div v-if="errors && errors.description" class="font-medium text-red-600">{{ errors.description[0] }}</div>
                                        </div>
